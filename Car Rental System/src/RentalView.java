...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//-----------------------------------TEXT AREA to pick a car putting details for car when we click buttons over top
		carDetailsTA = new JTextArea(6, 25);
		carDetailsTA.setText("=>01. Toyota | 2009 \n=>02. Hiace | 2012 \n=>03. Ambulance | 2010 \n=>04. Toyota Allion | 2018");
	...
	private class reserveNextButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("NextToCustomer")) {
				...
				if(!aTrans.toStringDateChecker().equals("TRUE")) { //check if valid or not to pick date and return date
	...
	private class customerNextButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("NextToPickCar")) {
				...
				if(!aCustomer.getFirstName().equals(" First Name ") && !aCustomer.getLastName().equals(" Last Name ") && !aCustomer.getGender().equals("M/F") && !aCustomer.getStatus().equals("S/Ma") && !aCustomer.getLocation().equals(" Address ") && !aCustomer.getContact().equals(" Contact Number ")){
	...
	private class firstCarButton implements ActionListener{ //button to show car details
		...
		carDetailsTA.setText("Brand: Toytota Corolla X\nPlate #: Dhaka Metro ga \nType: Private car\nModel: 2009\nColor: white\nRental Price: BDT 2000.00\n\n.");
	...
	private class forthCarButton implements ActionListener{ //button to show car details
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Toyota Allion\nPlate #: Dhaka metro ga\nType: Private car\nModel: 2018\nColor: Red\nRental Price: BDT 4000.00\n\n.");
